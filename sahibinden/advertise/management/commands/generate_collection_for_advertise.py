...
from advertise.models import Frontal, InteriorFeature, ExteriorFeature, Locality, SuitableForDisabled, Landscape, \
    Transportation
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        frontal_values = ["Batı", "Dogu", "Guney", "Kuzey"]
        ...
        exterior_feature = [
            ...
            "Kamera Sistemi",
            "Kapalı Garaj", "Kapıcı", "Kreş", "Otopark", "Oyun Parkı", "Sauna", "Ses Yalıtımı", "Spor Alanı",
            "Su Deposu", "Tenis Kortu",
